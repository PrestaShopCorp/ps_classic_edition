<template>
  <div class="vue-edition-homepage max-w-[1134px] mx-auto">
    <div class="mb-4">
      <h2 class="text-4xl font-bold uppercase mr-4">{{ $t("onb.homepage.title") }}</h2>
    </div>
...
import ContactUs from "@/modules/Onboarding/components/ContactUs.vue";
